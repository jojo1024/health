...
const PatientForm = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formState.socialSecurityNumber) {
      setFormError('Le numéro de sécurité sociale est obligatoire');
      return false;
    }

    // Validation du format du numéro de sécurité sociale français (simplifié)
    if (!/^\d{13,15}$/.test(formState.socialSecurityNumber)) {
      setFormError('Le numéro de sécurité sociale doit contenir entre 13 et 15 chiffres');
      return false;
    }
          ...
          <div className="relative bg-white rounded-lg p-6 max-w-md mx-auto shadow-xl">
            <div className="mb-4 text-center">
              ...
              <div className="mt-4 bg-gray-50 rounded-md p-3">
                ...
                <p className="text-sm text-gray-700">
                  <span className="font-medium">N° Sécurité sociale:</span> {formState.socialSecurityNumber}
                </p>
